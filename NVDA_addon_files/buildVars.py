...
addon_info = {
	...
	"addon_summary": _("Notepadplusplus for python development (for Notepad++ 32bits only)"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("""# Notepad++ NVDA AppModule for python development #

## Overview ##
This NVDA APP module helps to interact with Notepad++ for python development. It includes several features for navigating, selecting, and manipulating functions and classes in Python code.
...
## Notes ##
This module is designed to enhance productivity while working with Python code in Notepad++ (32 bits only) using NVDA. Each shortcut is carefully assigned to streamline navigation and code manipulation.
